...
# FastAPI is for creating the web app and JSONResponse is for displaying the blockchain
...
# Creating the Web App using FastAPI
app = FastAPI()
...
def home():
    ...
    <html>
        ...
        <body>
            ...
            <ul>
                <li><a href="/">Home</a></li>
                <li><a href="/mine_block">Mine Block</a></li>
                <li><a href="/get_chain">Get Chain</a></li>
